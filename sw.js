...
const CACHE_VERSION = 'prova-v3205-mega72-phase-a-read-paths';   // MEGA72-Phase-A (2026-05-14): READ-PATH MIGRATION Airtable→Supabase für 4 P1-Files (akte/dashboard/freigabe/archiv-logic.js). Adapter-Pattern: _supabaseRowToFields() wandelt auftraege-Row (objekt jsonb, details jsonb, enum-Columns) zurück in Airtable-Style CapitalCase-Feldnamen damit downstream render-Code (200+ Field-Access-Stellen) ohne flächige Rewrites weiterläuft. Plus: airtable-410-Wrapper (prova-fetch-auth.js) als DEPRECATED markiert mit console.warn für Live-Monitoring welche P2/P3-Files noch nicht migriert sind. Docs: MEGA72-PHASE-A-AUDIT.md (Datei-Tabelle-Priorisierung) + CLEANUP-FIELD-MAPPING.md (vollständiges Mapping pro Tabelle). Voraus: v3204 MEGA70-Phase-1.2.4 (Auftrag-Insert Schema-Drift Production-Stopper) + v3202 MEGA70-Phase-1.2.2 (Naming + Phase-Tracking + Pricing).
