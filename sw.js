...
const CACHE_VERSION = 'prova-v3211-mega72-marathon-snapshot';   // MEGA72 MARATHON 2026-05-14 (pragmatic): Phase A done (4 P1-Files) + Phase B-mini Track 0 (lib/prova-supabase-adapters.js DRY + 4 P1-Refactors, ~185 LOC dedup) + Phase B-mini Track 1 partial (3/8 P2-Files migriert: termine, rechnungen, beratung — 5 weitere als Phase-B-mini-followup in DECISIONS.md) + Phase D-quarantine (11 Zombies → _archiv/2026-05-14/ mit 7-Tage-Monitoring bis 2026-05-21). Documented-deferred: Phase B-write (audit-trail + SV-profile + onboarding-sync), Phase C (dashboard konsolidierung), Phase E (function-audit), Phase F (doku-refresh). Siehe docs/MEGA72-MARATHON-COMPLETE.md für Marcel-Action-Items + Branch-Topology + Live-Monitoring-Plan. Voraus: v3204 MEGA70-1.2.4 (Auftrag-Insert Schema-Fix) + v3202 MEGA70-1.2.2 (Naming + Pricing).
