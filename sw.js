...
const CACHE_VERSION = 'prova-v3850-mega88-a-logo-implementation';   // MEGA⁸⁸-A Logo-Implementation 2026-05-17: Block A 4 SVG-Assets (logo-prova-systems.svg Master + logo-prova.svg compact + logo-icon-only.svg + logo-icon-mono.svg) + tools/generate-logo-pngs.js Node-Script fuer Marcel-PNG-Run + Block B App-Integration (nav.js Sidebar mit Schild-Logo + Collapsed-Mode Icon-Only + 6 Auth-Pages Logo-Banner + Favicon-Refs auf app-login/app-register/admin-login/setup-2fa/account-2fa-status/workspace-invite/workspace-accept-invitation) + Block C Landing (index.html nav-logo + footer-logo-mark auf Master-SVG + Favicon-Refs im head) + Block D 2FA TOTP-URI mit image-Param via api.qrserver.com QR-Render + friendlyName 'PROVA · email' + Block E manifest.json mit theme-color #1a3a6b + 4 Icon-Sizes inkl. maskable + Block F email-templates/_shared/brand-header.html Snippet + trial-welcome.html als Beispiel-Patch + Block G docs/MEGA88-A-PDFMONKEY-LOGO-CHECKLIST.md mit 16+ Templates. Sprint-Historie: docs/SW-VERSION-HISTORY.md.
