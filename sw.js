...
const CACHE_VERSION = 'prova-v3950-mega88-d-coupon-security';   // MEGA⁸⁸-D Coupon-Security + Founding-90d-Trial 2026-05-18: Block A SECURITY FOUNDING-99 aus lib/prova-onboarding-tour.js entfernt (Step 5 dynamisch ueber _resolveCouponStep aus workspaces.founding_status statt hartcoded — Standard-User sehen generischen 'Bereit fuer ersten Fall'-Step, Founding/Pilot-User sehen Custom-Step ohne Code-Anzeige) + Block B Migration 63 (workspaces.founding_status + founding_assigned_at + stripe_coupon_assigned) + app-register.html ?founding=1 / ?pilot=1 URL-Param-Detection → 90d Trial + localStorage prova_founding_status_pending + lib/trial-banner.js Founding-Variante (🌟 + 'danach 99 €/mo lifetime') + Block C workspace-invite.html Founding-Tester-Checkbox (Marcel-only sichtbar via SUPER_ADMINS-Liste) + send-workspace-invitation Edge mit founding_invite-Flag (FOUNDING-MARKER in persoenliche_nachricht) + workspace-accept-invitation.html liest Marker und setzt founding_status='founding_member' + abo_trial_endet_am 90d. Sprint-Historie: docs/SW-VERSION-HISTORY.md.
