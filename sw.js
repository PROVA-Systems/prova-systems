...
const CACHE_VERSION = 'prova-v3800-mega87-auth-perfekt-2-0';   // MEGA⁸⁷ AUTH-PERFEKT 2.0 Voll-Rebuild 2026-05-17: Block A Audit + Inventory (member_rolle ENUM verifiziert {owner,admin,sv,assistenz,readonly} - Marcel-Memory war falsch) + Block B Netlify-Identity bereits seit MEGA46 entfernt (Polyfill bleibt als bewusste Compat-Architektur) + Block C Migration 61 (totp_recovery_codes_generated_at + _used_count Spalten) + Block D 2FA-Komplett (verify-mfa-recovery-code Edge NEU mit constant-time sha256-Match + Code-Verbrauch + Audit, generate-mfa-recovery-codes Edge NEU mit 10 frischen Codes Format XXXX-XXXX, account-2fa-status.html NEU als Verwaltungs-Page) + Block E Workspace-Switcher (lib/workspace-switcher.js NEU mit Auto-Mount-Dropdown + Cmd+B-Hotkey-frei + Audit bei Switch + Page-Reload) + Block F Workspace-Invitations (workspace-invite.html NEU mit Email+Rolle-Form, supabase/functions/send-workspace-invitation NEU mit Permission-Check + 7d-Token + send-email-Wrapper, workspace-accept-invitation.html NEU mit Token-Verify + Annehmen/Ablehnen) + Block G Account-Settings (einstellungen.html erweitert: Alle-Sessions-Ausloggen + 2FA-Status-Link + Workspace-Mitgliedschaften-Summary + Team-Invite-Link auf /workspace-invite.html) + Block H Auth-Cockpit (admin-kpis.html Live-Sessions-Section mit Force-Sign-Out + Failed-Login-Drilldown-Modal mit Top-10-Email/IP-Stats). Sprint-Historie: docs/SW-VERSION-HISTORY.md.
