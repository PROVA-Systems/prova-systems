  ...
  try {
    switch (stripeEvent.type) {
      ...
      case 'checkout.session.completed': {
        ...
        // Airtable: Status auf Aktiv setzen
        await aktualisiereAirtableStatus(email, 'Aktiv', paket, subId);

        // Make.com S3: Aktivierungs-E-Mail + interne Benachrichtigung
    ...
    // 200 zurückgeben damit Stripe nicht wiederholt (wir haben den Error geloggt)
    return {
      statusCode: 200,
      headers,
