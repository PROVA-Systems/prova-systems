...
// K-1.5 Cutover: Supabase-Auth ist alleinige Quelle der Wahrheit.
// /app-login.html (alter Netlify-Identity-Login) wird via 301 auf
// /auth-supabase.html geleitet (siehe netlify.toml). Hier setzen wir
// das Ziel direkt, damit auch ohne Redirect (z.B. lokale Dev-Server)
// der richtige Login geoeffnet wird.
const LOGIN_PAGE = '/auth-supabase.html';
const ONBOARDING_PAGE = '/onboarding-supabase.html';
// Default-Logout-Redirect: Landing-Page (Marketing).
 ...
 */
export function bindLogoutButtons(redirectTo = LOGOUT_REDIRECT) {
