...
(function () {
  ...
  // 13-Monate-Re-Show (DSK-Empfehlung 2025 — Consent erneut einholen, max. 13 Monate gültig)
  const CONSENT_MAX_AGE_MS = 13 * 30 * 24 * 60 * 60 * 1000; // ≈13 Monate
  ...
  function hasConsent() {
    try {
      ...
      if (isNaN(age) || age > CONSENT_MAX_AGE_MS) {
        // Consent abgelaufen — clean state, Banner zeigt sich wieder
