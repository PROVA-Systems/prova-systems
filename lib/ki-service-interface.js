...
function calculateCostEur(provider, model, tokensIn, tokensOut) {
  // Stand 10.05.2026 — MEGA²⁸ W3-I0 Modell-Update
  const PRICES_USD_PER_1M = {
    ...
    // Anthropic — Aktuell (Schätzungen, vor Live-Verifikation)
    ...
    'whisper-1':                 { input: 0.006, output: 0 }       // pro Minute
  };
  const USD_TO_EUR = 0.92;
  const p = PRICES_USD_PER_1M[model] || PRICES_USD_PER_1M['gpt-5.4-mini'];
