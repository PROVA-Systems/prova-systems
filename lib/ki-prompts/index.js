...
const PROMPTS = {
  ...
  'flow-a': {
    'konjunktiv-ii-pruefung': {
      ...
      model: 'gpt-5.5',  // MEGA²⁸ W3-I0: Konjunktiv II: Frontier-Modell (CLAUDE.md Regel 14)
      max_tokens: 800
    },
    'halluzinations-check': {
      ...
      model: 'gpt-5.5', // MEGA²⁸ W3-I0: Compliance-kritisch
      max_tokens: 1000
    },
    ...
    'fachurteil-entwurf': {
      ...
      model: 'gpt-5.5', // MEGA²⁸ W3-I0: Frontier (Konjunktiv-II-Pflicht)
      max_tokens: 1200
    }
  },
  ...
  'flow-b': {
    'wert-zusammenfassung': {
      ...
      model: 'gpt-5.4-mini', // MEGA²⁸ W3-I0: leichte Aufgabe
      max_tokens: 800
    }
  },
