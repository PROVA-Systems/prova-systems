...
// Session 5: PROVASearch explizit auf window exposen.
// Grund: `const PROVASearch` landet sonst NICHT auf window (nur var würde das tun).
// Playwright + inline-onclick-Handler prüfen `window.PROVASearch` — muss also da sein.
