...
## 🆕 MEGA³¹ D1 — Diktat-Strukturierung-Action (07.05.2026)

**Action:** `diktat_strukturierung`
**Modell:** gpt-5.4-mini (Light, Latency-optimiert)
**Backup:** claude-haiku-4-5-20251001
**Purpose:** strukturiert pseudonymisiertes Diktat-Transkript in §1-§5

**Input:** transkript (string, min 30 chars, pseudonymisiert)
**Output JSON:**
```
{ paragraf_1, paragraf_2, paragraf_3, paragraf_4, paragraf_5 }
```

**System-Prompt-Vorlage:** siehe `netlify/functions/ki-diktat-strukturierung.js`
- §1 Anlass — Was war der Auftrag?
- §2 Sachverhalt — Was wurde vor Ort vorgefunden? (rein faktisch)
- §3 Anknüpfungstatsachen — Daten/Messwerte/Unterlagen
- §4 Befunde — Beobachtungen (rein faktisch, keine Wertung)
- §5 Beweisfragen — Fragen für Begutachtung

**Compliance:**
- KEINE Kausalaussagen oder Wertungen (das ist §6 Sache des SV, Regel 11)
- Konjunktiv II nicht erforderlich (§1-§5 sind faktisch)
- KEINE PII rekonstruieren (Pseudonymisierung-Layer beibehalten, Regel 17)

**ki_protokoll-Logging:** via `lib/ki-cost-tracker.js` Pflicht (Regel 16)
