...
(function() {
  ...
  if (!document.getElementById('prova-trial-css')) {
    ...
    s.textContent = ''
      + '.trial-badge{position:fixed;top:12px;right:12px;z-index:600;padding:6px 14px;border-radius:8px;font-size:11px;font-weight:700;font-family:inherit;display:flex;align-items:center;gap:6px;cursor:pointer;transition:all .15s;}'
