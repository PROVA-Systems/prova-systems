-- PROVA Systems · DB Schema-Planung · MEGA¹⁴ W28
-- Foundation fuer Triple-Mode-Workflow-System (Mode A/B/C)
--
-- STATUS: PLANNED — Implementation in MEGA¹⁵ (Mode B)
-- WICHTIG: Marcel-OK pflicht vor Anwendung in Production
--
-- Anwendung im Sprint:
--   1. Marcel reviewed dieses File
--   2. Marcel approved
--   3. Migration in /supabase-migrations/<NN>_user_workflow_settings.sql kopieren
--   4. Production-Migration via Supabase-CLI
--
